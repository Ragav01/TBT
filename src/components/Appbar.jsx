    ...
    return (
        <div className='h-16 px-4 sticky top-0 z-30 bg-white flex items-center justify-between'>
            <div className='relative'>
                ...
                <input type="text" placeholder='Search menus, Tickets, Etc' className='outline-none border border-borderColor-secondary rounded-md pl-10 pr-4 h-10 w-[280px] xl:w-[532px]' />
            ...
            <div className='flex gap-x-4'>
                <NavLink to={'tickets/addticket'} className='h-10 px-4 flex items-center gap-x-2 bg-primary-500 hover:bg-primary-600 text-base font-medium text-base-white rounded-md'>
